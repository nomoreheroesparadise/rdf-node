...
const {
  ...
  setDomainInfo,
  hasResourceInPath,
  getVisitedUrlsentries,
  getToBeVisitedUrlsentries,
...
describe('Crawler', () => {
  describe('getUrls function', () => {
    ...
    // before(() => Promise.resolve(getBody('https://ephesusbreeze.com/es/tours'))
    //     .then(getUrls)
    //     .then((data) => {
    //       urls = data;
    //       return null;
    ...
    it('it should return array', (done) => {
      return Promise.resolve(getBody('https://ephesusbreeze.com/tours'))
      .then(html => getUrls(html, 'jsonld'))
      .then(() => getBody('https://ephesusbreeze.com/es/tours'))
      .then(html => getUrls(html, 'jsonld'))
      .then(() => {
        console.log('VISITED', getVisitedUrlsentries())
        console.log('TO BE VISITED', getToBeVisitedUrlsentries())
      })
